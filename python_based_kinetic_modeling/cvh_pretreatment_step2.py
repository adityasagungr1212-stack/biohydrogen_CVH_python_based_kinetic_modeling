...
file_path = r'e:\Document 2026\Hydrogen project\Dark\Pyton based kinetic modeling\Step 2.xlsx'
...
for model_name in models.keys():
    ...
    plt.ylabel(r"Cumulative hydrogen yield (CVH, mL H$_2$/gVS)", fontweight="bold")
